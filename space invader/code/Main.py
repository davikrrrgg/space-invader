...
def start():
    ...
    m=[
        [20,20,999,-30,True,True,bot1,0,bot_laser,False]
    ]
    ...
    def game_over():
        ...
        screen.blit(game_over_txt, (70,150))
        aggiorna()
        while 1==1:
            for event in pygame.event.get():
                if event.type==pygame.KEYDOWN:
    ...
    while True:
        ...
        while r<lvl:
            ...
            if xl>m[r][0] and xl< m[r][0]+50 and yl>m[r][1] and yl<m[r][1]+50:              #collisioni
                m[r][4]=False
                m[r][3]=999
                m[r][2]=999


            if m[r][4]==True:                                                           #incremento livello e controllo di livello in corso
                break
            else:
                if r==lvl-1:
                    if(lvl>3 and lvl<6):                    #divisioni nelle linee in y
                        v=[20,70,999,-330,True,True,bot1,0.1,bot_laser,False]
                    else:
                        v=[20,20,999,-330,True,True,bot1,0.1,bot_laser,False]
                    if(lvl>6):
                        v=[20,120,999,-330,True,True,bot1,0.1,bot_laser,False]
        ...
        while(r<lvl):
            ...
            if m[r][7]>10:
                ...
                m[r][2]=m[r][0]-14
                m[r][3]=m[r][1]+40
            if(m[r][3]>y and m[r][4]==True):                              #collisioni game over
                if m[r][2]>x-48 and m[r][2]<x+20:
                    game_over()
